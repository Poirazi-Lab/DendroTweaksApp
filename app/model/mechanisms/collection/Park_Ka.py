...
class Park_Ka(CustomVoltageDependentIonChannel):
    def __init__(self, cell=None):
        super().__init__(name='Park_Ka', suffix='ka', cell=cell)
        self.ion = 'k'
        self.range_params = [
            'gbar',
        ]
    ...
    def rates(self, v):
        ...
        self.taun = self.betn(v) / ((self.tadj * self.a0n) * (1 + self.a))
        ...
        self.taul = (0.26 * (v + 50)) / self.qtl
        conditions = [self.taul < (self.lmin / self.qtl),
                      ~(self.taul < (self.lmin / self.qtl))]
        choices = [self.lmin / self.qtl,
                   self.taul]
